...
class FuncionariosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create funcionario" do
    assert_difference("Funcionario.count") do
      post funcionarios_url, params: { funcionario: { cargo_id: @funcionario.cargo_id, cpf: @funcionario.cpf, nome: @funcionario.nome, rg: @funcionario.rg, setor_id: @funcionario.setor_id, telefone: @funcionario.telefone } }
    end
  ...
  test "should update funcionario" do
    patch funcionario_url(@funcionario), params: { funcionario: { cargo_id: @funcionario.cargo_id, cpf: @funcionario.cpf, nome: @funcionario.nome, rg: @funcionario.rg, setor_id: @funcionario.setor_id, telefone: @funcionario.telefone } }
