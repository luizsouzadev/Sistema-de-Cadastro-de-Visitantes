...
class UnidadesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create unidade" do
    assert_difference("Unidade.count") do
      post unidades_url, params: { unidade: { nome: @unidade.nome, secretaria_id: @unidade.secretaria_id } }
    end
  ...
  test "should update unidade" do
    patch unidade_url(@unidade), params: { unidade: { nome: @unidade.nome, secretaria_id: @unidade.secretaria_id } }
