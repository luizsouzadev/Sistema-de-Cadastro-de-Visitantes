module Admin
class SetorsController < AdminController
  ...
  def create
    ...
    respond_to do |format|
      if @setor.save
        format.html { redirect_to admin_setor_url(@setor), notice: "Setor was successfully created." }
  ...
  def update
    respond_to do |format|
      if @setor.update(setor_params)
        format.html { redirect_to admin_setor_url(@setor), notice: "Setor was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to admin_setors_url, notice: "Setor was successfully destroyed." }
  ...
  private
    ...
    def setor_params
      params.require(:setor).permit(:nome, :unidade_id, :secretaria_id)
    end
end
end
