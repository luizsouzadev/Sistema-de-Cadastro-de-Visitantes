module Admin
class UnidadesController < AdminController
  ...
  def create
    ...
    respond_to do |format|
      if @unidade.save
        format.html { redirect_to admin_unidade_url(@unidade), notice: "Unidade was successfully created." }
  ...
  def update
    respond_to do |format|
      if @unidade.update(unidade_params)
        format.html { redirect_to admin_unidade_url(@unidade), notice: "Unidade was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to admin_unidades_url, notice: "Unidade was successfully destroyed." }
  ...
  private
    ...
    def unidade_params
      params.require(:unidade).permit(:nome, :secretaria_id)
    end
end
end
