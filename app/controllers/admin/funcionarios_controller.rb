...
class FuncionariosController < AdminController
  ...
  def create
    ...
    respond_to do |format|
      if @funcionario.save
        format.html { redirect_to admin_funcionario_url(@funcionario), notice: "Funcionario was successfully created." }
  ...
  def update
    respond_to do |format|
      if @funcionario.update(funcionario_params)
        format.html { redirect_to admin_funcionario_url(@funcionario), notice: "Funcionario was successfully updated." }
  ...
  private
    ...
    def funcionario_params
      params.require(:funcionario).permit(:nome, :cpf, :rg, :telefone, :setor_id, :cargo_id, :secretaria_id, :unidade_id, :email, :password)
    end
end
end
